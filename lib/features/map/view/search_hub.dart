...
class SraechHub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ShowPathBloc()..add(GetHistory()),
      child: Builder(
          builder: (context) {
            return Scaffold(
                      ...
                      Padding(
                        ...
                        child: ButtonCustom(0,0, screenHight*0.06,const Row(
                         ...
                         if(destination.value.text != 'Your location'){
                          ...
                          HistoryModel historyModel=HistoryModel( statrPoint: start.value.text, destinationPoint: destination.value.text, id: 1);
                          context.read<ShowPathBloc>().add(AddToHistory(historyModel));
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [ 
                            ...
                            BlocConsumer<ShowPathBloc,MapStates>(
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: ListTile(
                                                      ...
                                                      trailing: IconButton(onPressed: (){context.read<ShowPathBloc>().add(DeleteHistory(state.data[index].id));},icon: Icon(Icons.delete,color: darkRedColor,size: 16,),)
                                                    ),
                                                  ),
                                                ],
                                              ),
                              ...
                              if(state is SuccessBoolState){
                                context.read<ShowPathBloc>().add(GetHistory());
                              }
                            },
