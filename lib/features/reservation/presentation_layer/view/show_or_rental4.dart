        ...
        child: ListView(
          children: [
            ...
            Padding(
              ...
              child: Center(child: ButtonCustom(0, screenWidth*0.76, screenHight*0.06, Text(rentalBike,style: TextStyle(color: darkGreenColor,fontSize: 20),), lightGreenColor, darkGreenColor, (){
            ...
            Center(
              child: ButtonCustom(0, screenWidth*0.76, screenHight*0.06, Text(showBikeList,style: TextStyle(color: darkGreenColor,fontSize: 20)), lightGreenColor, darkGreenColor, (){
