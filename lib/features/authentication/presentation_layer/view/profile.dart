...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<AuthBloc>(
      create: (context) => sl()..add(ProfileEvent(userHive!.get("username"))),
      child: Builder(
          builder: (context) {
            return Scaffold(
                  ...
                  if(state is SuccessStatee){
                    return Form(
                      ...
                      child: ListView(
                        children: [
                          Padding(
                            padding: leftAndRightAndTopAndTBottomPadding(0.34,0.04,0.06, 0.1),
                          ...
                          Padding(
                            ...
                            child: ButtonCustom(0,0, screenHight*0.06, const Text(edit,style: TextStyle(fontSize: 26,color: white),), darkGreenColor, darkGreenColor, (){
                              ...
                              UserRegisterEntity userModel=UserRegisterEntity(firstName: fitrstNameController.text,lastName: lastNameController.text,phone: mobailController.text,username: userNameController.text,birthDate: birthDateController,password: 'avsawaQAQ1332!1',confirmPassword: 'avsawaQAQ1332!1');
