...
class _EditBicycleState extends State<EditBicycle> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => BicycleSupaBloc(),
        child: Builder(
            builder: (context) {
              return Scaffold(
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: ButtonCustom(0,screenWidth*0.3, screenHight*0.06, BlocBuilder<BicycleSupaBloc,BicycleStates>(
                              ...
                              BicycleSupaModel bicycleSupaModel=BicycleSupaModel(id:1,modelName: modelController.text,price: double.parse(priceController.text),size: int.parse(sizeController.text),note: 'no thing',type: typeController.text,photoPath: photoController.text);
                              context.read<BicycleSupaBloc>().add(EditBicycleSupa(widget.id,bicycleSupaModel));
                            }),
                          ),
                        ),
                      ],
