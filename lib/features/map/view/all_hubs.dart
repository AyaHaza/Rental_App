...
class AllHubs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => MapHubsBloc()..add(GetHubs(location))),
                        ...
                        if(state is SuccessState){
                          ...
                          builder: (context, stateTwo) {
                                          ...
                                          trailing: Container(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                ):IconButton(onPressed: (){context.read<MapHubsSupaBloc>().add(DeleteHubsSupa(hubs[index].id));} ,icon: Icon(Icons.delete,color: darkRedColor)),
                                              ],
                                            ),
                                          ),
                                        ),
                            ...
                            if(state is SuccessBoolState){
                              context.read<MapHubsBloc>().add(GetHubs(location));
