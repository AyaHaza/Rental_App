...
class PostFavouriteModel {
    ...
    factory PostFavouriteModel.fromRawJson(String str) => PostFavouriteModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory PostFavouriteModel.fromJson(Map<String, dynamic> json) => PostFavouriteModel(
